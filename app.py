...
# ============================================================
# Runtime startup inside the Gunicorn worker
# ============================================================
# Gunicorn imports this module in the master process and then forks
# the HTTP worker. Threads started before that fork do not survive
# in the worker that receives /webhook.
#
# Start the application lazily on the first request so the queues,
# scheduler and background workers are created inside the real
...
# Gunicorn startup
# ============================================================
# Background threads are intentionally NOT started at module import.
# They are started by ensure_application_initialized() inside the
# Gunicorn HTTP worker process.
#
# IMPORTANT FOR RENDER:
# Use ONE Gunicorn worker because the scheduler and in-memory queues
